...
class DocumentsController extends Controller
{
    ...
    {
        $this->middleware('admin:index-list_documents|create-create_document|show-view_document|edit-edit_document|destroy-delete_document|getAssignDocument-assign_document', ['except' => ['store', 'update','postAssignDocument']]);
        $this->mailer = $mailer;
    }
    /**
