...
{
    $folder = \App\Models\Models\MailboxFolder::where('title', "Inbox")->first();

    $messages = \App\Models\Models\Mailbox::join('mailbox_receivers', 'mailbox_receivers.mailbox_id', '=', 'mailboxes.id')
