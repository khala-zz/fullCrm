...
<?php $__env->startSection('title', ' | Assign task'); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(url('/admin/tasks/' . $task->id . '/assign')); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crm_laravel\resources\views/pages/tasks/assign.blade.php ENDPATH**/ ?>