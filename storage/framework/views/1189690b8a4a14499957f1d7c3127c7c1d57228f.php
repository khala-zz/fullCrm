            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(url('admin/roles' . '/' . $role->id)); ?>" accept-charset="UTF-8" style="display:inline">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> <?php echo e($role->name); ?> </td></tr>
                                    <tr>
                                        <th>Permissions</th>
                                        <td>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crm_laravel\resources\views/pages/roles/show.blade.php ENDPATH**/ ?>