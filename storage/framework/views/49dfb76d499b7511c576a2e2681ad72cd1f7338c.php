<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
    ...
    <input class="form-control" name="name" type="text" id="name" value="<?php echo e(isset($role->name) ? $role->name : ''); ?>" required>
...
</div><?php /**PATH C:\xampp\htdocs\crm_laravel\resources\views/pages/roles/form.blade.php ENDPATH**/ ?>